...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_consultation_requests_education" AS ENUM('bachelor', 'master', 'phd', 'other');
  ...
  CREATE TABLE "consultation_requests" (
  	...
  	"education" "enum_consultation_requests_education" NOT NULL,
  	"topic" varchar,
  	"notes" varchar,
  	"locale" varchar,
  	"source_page" varchar,
  ...
  CREATE TABLE "homepage_hero_pills" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage_hero_metrics" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage_services_items_points" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage_mentors_items_focus" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage_mentors_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage_process_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage_faqs_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "homepage" (
  	...
  	"cta_primary_url" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  
  CREATE TABLE "homepage_locales" (
  	"hero_metric_title" varchar,
  	"hero_title" varchar,
  	"hero_description" varchar,
  	"hero_metric_caption" varchar,
  	"services_title" varchar,
  	"mentors_title" varchar,
  	"stories_title" varchar,
  	"process_title" varchar,
  	"faqs_title" varchar,
  	"consultation_title" varchar,
  	"consultation_description" varchar,
  	"consultation_button_label" varchar,
  ...
  ALTER TABLE "homepage_hero_pills" ADD CONSTRAINT "homepage_hero_pills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "homepage_hero_metrics" ADD CONSTRAINT "homepage_hero_metrics_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_services_items_points" ADD CONSTRAINT "homepage_services_items_points_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage_services_items"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "homepage_mentors_items_focus" ADD CONSTRAINT "homepage_mentors_items_focus_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage_mentors_items"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_mentors_items" ADD CONSTRAINT "homepage_mentors_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "homepage_process_items" ADD CONSTRAINT "homepage_process_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "homepage_faqs_items" ADD CONSTRAINT "homepage_faqs_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."homepage"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "homepage_hero_pills_order_idx" ON "homepage_hero_pills" USING btree ("_order");
  CREATE INDEX "homepage_hero_pills_parent_id_idx" ON "homepage_hero_pills" USING btree ("_parent_id");
  CREATE INDEX "homepage_hero_pills_locale_idx" ON "homepage_hero_pills" USING btree ("_locale");
  ...
  CREATE INDEX "homepage_hero_links_locale_idx" ON "homepage_hero_links" USING btree ("_locale");
  CREATE INDEX "homepage_hero_metrics_order_idx" ON "homepage_hero_metrics" USING btree ("_order");
  CREATE INDEX "homepage_hero_metrics_parent_id_idx" ON "homepage_hero_metrics" USING btree ("_parent_id");
  CREATE INDEX "homepage_hero_metrics_locale_idx" ON "homepage_hero_metrics" USING btree ("_locale");
  CREATE INDEX "homepage_services_items_points_order_idx" ON "homepage_services_items_points" USING btree ("_order");
  CREATE INDEX "homepage_services_items_points_parent_id_idx" ON "homepage_services_items_points" USING btree ("_parent_id");
  CREATE INDEX "homepage_services_items_points_locale_idx" ON "homepage_services_items_points" USING btree ("_locale");
  ...
  CREATE INDEX "homepage_services_items_locale_idx" ON "homepage_services_items" USING btree ("_locale");
  CREATE INDEX "homepage_mentors_items_focus_order_idx" ON "homepage_mentors_items_focus" USING btree ("_order");
  CREATE INDEX "homepage_mentors_items_focus_parent_id_idx" ON "homepage_mentors_items_focus" USING btree ("_parent_id");
  CREATE INDEX "homepage_mentors_items_focus_locale_idx" ON "homepage_mentors_items_focus" USING btree ("_locale");
  CREATE INDEX "homepage_mentors_items_order_idx" ON "homepage_mentors_items" USING btree ("_order");
  CREATE INDEX "homepage_mentors_items_parent_id_idx" ON "homepage_mentors_items" USING btree ("_parent_id");
  CREATE INDEX "homepage_mentors_items_locale_idx" ON "homepage_mentors_items" USING btree ("_locale");
  ...
  CREATE INDEX "homepage_stories_items_locale_idx" ON "homepage_stories_items" USING btree ("_locale");
  CREATE INDEX "homepage_process_items_order_idx" ON "homepage_process_items" USING btree ("_order");
  CREATE INDEX "homepage_process_items_parent_id_idx" ON "homepage_process_items" USING btree ("_parent_id");
  CREATE INDEX "homepage_process_items_locale_idx" ON "homepage_process_items" USING btree ("_locale");
  CREATE INDEX "homepage_faqs_items_order_idx" ON "homepage_faqs_items" USING btree ("_order");
  CREATE INDEX "homepage_faqs_items_parent_id_idx" ON "homepage_faqs_items" USING btree ("_parent_id");
  CREATE INDEX "homepage_faqs_items_locale_idx" ON "homepage_faqs_items" USING btree ("_locale");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "homepage_hero_pills" CASCADE;
  DROP TABLE "homepage_hero_links" CASCADE;
  DROP TABLE "homepage_hero_metrics" CASCADE;
  DROP TABLE "homepage_services_items_points" CASCADE;
  DROP TABLE "homepage_services_items" CASCADE;
  DROP TABLE "homepage_mentors_items_focus" CASCADE;
  DROP TABLE "homepage_mentors_items" CASCADE;
  DROP TABLE "homepage_stories_items" CASCADE;
  DROP TABLE "homepage_process_items" CASCADE;
  DROP TABLE "homepage_faqs_items" CASCADE;
  ...
  DROP TYPE "public"."enum_consultation_requests_education";
